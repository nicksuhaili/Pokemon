...
class _PokemonApiService implements PokemonApiService {
  ...
  Future<PokemonDetails?> getPokemonDetails(String name) async {
    ...
    final _options = _setStreamType<PokemonDetails>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late PokemonDetails? _value;
    try {
      _value =
          _result.data == null ? null : PokemonDetails.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<PokemonListResponse> getPokemonList(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PokemonListResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
